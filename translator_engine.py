...
# Extraction du texte SDT (BLOC uniquement, pas inline)
...
def replace_sdt_text(sdt, new_text):
    ...
    if paragraphs:
        ...
        # Cas particulier : SDT inline sans <w:p> (rare)
        ...
        if text:
            if use_segmentation:
                ...
                for sentence in sentences:
                    if sentence.strip():
                        segments.append(('p', p, sentence, True))
            else:
                segments.append(('p', p, text, False))
